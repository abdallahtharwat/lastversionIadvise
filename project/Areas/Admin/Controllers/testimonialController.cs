...
namespace project.Areas.Admin.Controllers
{
    ...
    public class testimonialController : Controller
    {
        ...
        {
            List<testimonial> featurelist = _UnitofWork.testimonial.GetAll().ToList();
        ...
        // post create
        [HttpPost]
        public IActionResult Create(testimonial header, IFormFile? file)  //  (obj== anta btstlm el value el fe post method input fe el create view )  when we have the obj here that will have the value of category that needs to be add
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(header.img))
                    {
                        var oldimagepath = Path.Combine(wwwRootPath, header.img.TrimStart('\\'));
                    ...
                    header.img = @"/images/product/" + fileName;
                }



                _UnitofWork.testimonial.add(header);
                _UnitofWork.Save();
        ...
        public IActionResult Edit(int? id)
        {
            ...
            testimonial? lenstypefromDb = _UnitofWork.testimonial.Get(u => u.Id == id); ;
        ...
        // post Edit
        [HttpPost]
        public IActionResult Edit(testimonial header, IFormFile? file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _UnitofWork.testimonial.Update(header);
                _UnitofWork.Save();
        ...
        public IActionResult Deletepost(int? id, IFormFile? file)
        {
            ...
            testimonial obj = _UnitofWork.testimonial.Get(u => u.Id == id);
            if (obj == null)
            {
                return NotFound();
            }
